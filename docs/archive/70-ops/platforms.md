# Copy-Paste Viability Across Six Platforms — Synthesis

**Prepared:** 2026-08-10. **Method:** merge of six independently researched and adversarially verified platform investigations. Where a verifier refuted a researcher, the verifier's finding is carried unless the researcher held better evidence.

**Provenance note, per ADR-0034.** I am the synthesist. **I opened no URLs myself.** Every URL and every date below is carried from the named investigation that opened it; nothing here is answered from memory, and nothing is asserted that no investigation established. Where the two disagreed, I say which won and why.
