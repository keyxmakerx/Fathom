...
/// line 3 of every payload [`a_plain_face_payload`] writes -- `"0.11"` at time
/// of writing, whose minor component this is. Kept as its own named constant
/// rather than a bare `11` at each call site so a future schema bump has one
/// place to change.
const CURRENT_SCHEMA_WIRE_VERSION: u32 = 11;
