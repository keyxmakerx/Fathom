      ...
      chassis: [
        {
          ...
          face: 'front',
          ports: [
            { id: 'port-1', label: '0', connector: 'RJ45', row: 0, column: 0, role: null, uplink: false, cable: null, face: 'front' },
            { id: 'port-2', label: 'xe-0', connector: 'SFP+', row: 0, column: 1, role: null, uplink: true, cable: null, face: 'front' },
          ],
          role: null,
