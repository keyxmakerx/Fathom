...
- **The product has been opened in a browser, and it now has an input.** WO-08's sixteen manual
  ...
  the plain-English account is `overnight-report.md`. **The module is 852,918 bytes against `44` §5.2's
  900,000-byte ceiling** (re-measured 2026-08-11, after the hand-authoring commits) — 47,082 bytes
  of headroom. **The often-cited "+239,964 for persistence" prices the wrong feature**: it is the
...
- `cargo test --workspace --locked` — 420 tests as of 2026-08-11; green is the gate, not the
